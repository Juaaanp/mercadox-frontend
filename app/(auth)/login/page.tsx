...
const STYLES = `
  ...
  .lx-f3 { animation:lx-up .6s .18s ease both; }
  .lx-f4 { animation:lx-up .6s .26s ease both; }
  .lx-f5 { animation:lx-up .6s .34s ease both; }
  ...
  .lx-btn-ghost {
    ...
    color:${T.muted}; background:transparent; transition:all .2s; width:100%;
  }
        ...
        <div style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
          ...
          <div className="lx-f1" style={{ marginBottom: 32 }}>
            ...
            <p style={{ color: T.muted, fontSize: 14, lineHeight: 1.6 }}>
              Ingresa tus datos para acceder a tu cuenta de Mercadox.
            </p>
          </div>
